# Historical TradingAgents operating audit

Preserved verbatim from root `CLAUDE.md` on 2026-09-14. The text below is
historical evidence, not active instructions, current status, or authorization.
Its dated account, trading, schedule, model, and verification claims must not
be used to establish present state. Current entry guidance is `../../AGENTS.md`.
