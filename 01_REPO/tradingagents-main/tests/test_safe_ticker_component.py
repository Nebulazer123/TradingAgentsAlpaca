...
def test_get_current_date_uses_utc_date_for_aware_datetime():
    local_next_day = datetime.fromisoformat("2026-06-05T00:30:00+14:00")

    assert get_current_date(local_next_day) == "2026-06-04"


def test_get_current_date_treats_naive_datetime_as_utc():
    assert get_current_date(datetime(2026, 6, 4, 23, 59, tzinfo=None)) == "2026-06-04"
