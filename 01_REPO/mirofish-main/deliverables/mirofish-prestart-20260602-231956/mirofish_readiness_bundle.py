    ...
    return {
        ...
        "objective_alignment": [
            ...
            },
            {
                ...
                "status": "prepared" if prepared.get("prepared_stage01_stage02_ok") and prepared.get("agent_count") == 1000 else "check",
                "evidence": "expanded population quotas cover retail, broker/platform, developer, media, policy/regulatory, institutional/liquidity, and tech-company/executive actors.",
            },
            {
